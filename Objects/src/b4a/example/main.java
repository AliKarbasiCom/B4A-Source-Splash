...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 27;BA.debugLine="Activity.LoadLayout(\"splash\")";
mostCurrent._activity.LoadLayout("splash",mostCurrent.activityBA);
 //BA.debugLineNum = 29;BA.debugLine="timer1.Initialize(\"splash\",3000)";
_timer1.Initialize(processBA,"splash",(long) (3000));
 //BA.debugLineNum = 30;BA.debugLine="timer1.Enabled = True";
...
public static String  _splash_tick() throws Exception{
 //BA.debugLineNum = 42;BA.debugLine="Sub splash_Tick";
